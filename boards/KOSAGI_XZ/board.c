  ...
  .ports = {
    {
      ...
      .pads = {
        ...
        /*PTA18*/ PAL_MODE_OUTPUT_PUSHPULL, /*PTA19*/ PAL_MODE_OUTPUT_PUSHPULL, /*PTA20*/ PAL_MODE_UNCONNECTED,
    ...
    },
    {
      .port = IOPORT2,  // PORTB
      .pads = {
        /* PTB0*/ PAL_MODE_INPUT_PULLUP,    /* PTB1*/ PAL_MODE_OUTPUT_PUSHPULL, /* PTB2*/ PAL_MODE_ALTERNATIVE_2, // i2c0
        /* PTB3*/ PAL_MODE_ALTERNATIVE_2,   /* PTB4*/ PAL_MODE_UNCONNECTED,     /* PTB5*/ PAL_MODE_UNCONNECTED,
        ...
        /*PTB15*/ PAL_MODE_UNCONNECTED,     /*PTB16*/ PAL_MODE_ALTERNATIVE_3,   /*PTB17*/ PAL_MODE_OUTPUT_PUSHPULL, // UART0 rx + select
        /*PTB18*/ PAL_MODE_OUTPUT_PUSHPULL, /*PTB19*/ PAL_MODE_OUTPUT_PUSHPULL,/*PTB20*/ PAL_MODE_UNCONNECTED,  // fpga creset, wlan reset
    ...
    },
    {
      .port = IOPORT3,  // PORTC
      .pads = {
        /* PTC0*/ PAL_MODE_INPUT,           /* PTC1*/ PAL_MODE_INPUT,           /* PTC2*/ PAL_MODE_OUTPUT_PUSHPULL, //sim1, sim2 detect, fpga_ss
        /* PTC3*/ PAL_MODE_ALTERNATIVE_7,   /* PTC4*/ PAL_MODE_ALTERNATIVE_7,   /* PTC5*/ PAL_MODE_ALTERNATIVE_2, // lpuart dbg rx, tx, fpga_sck
        /* PTC6*/ PAL_MODE_ALTERNATIVE_2,   /* PTC7*/ PAL_MODE_ALTERNATIVE_2,   /* PTC8*/ PAL_MODE_OUTPUT_PUSHPULL,// fpga mosi, miso, batt_srst
        /* PTC9*/ PAL_MODE_OUTPUT_PUSHPULL, /*PTC10*/ PAL_MODE_ALTERNATIVE_2,   /*PTC11*/ PAL_MODE_ALTERNATIVE_2, // sim_sel, i2c1
    ...
    },
    {
      .port = IOPORT4,  // PORTD
      .pads = {
        /* PTD0*/ PAL_MODE_INPUT_PULLUP,    /* PTD1*/ PAL_MODE_OUTPUT_PUSHPULL, /* PTD2*/ PAL_MODE_ALTERNATIVE_3, // gg_alarmb, uart2sel, uart2rx
        /* PTD3*/ PAL_MODE_ALTERNATIVE_3,   /* PTD4*/ PAL_MODE_OUTPUT_PUSHPULL, /* PTD5*/ PAL_MODE_ALTERNATIVE_7, // uart2tx7816, fpga_ss1, sck
        /* PTD6*/ PAL_MODE_ALTERNATIVE_7,   /* PTD7*/ PAL_MODE_ALTERNATIVE_7,   /* PTD8*/ PAL_MODE_UNCONNECTED, // fpga1 mosi, miso
    ...
    },
    {
      .port = IOPORT5,  // PORTE
      .pads = {
        /* PTE0*/ PAL_MODE_OUTPUT_PUSHPULL, /* PTE1*/ PAL_MODE_ALTERNATIVE_3,   /* PTE2*/ PAL_MODE_UNCONNECTED, // uart1sel, uart1rx
