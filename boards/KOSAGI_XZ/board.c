  ...
  .ports = {
    ...
    },
    {
      ...
      .pads = {
        ...
        /*PTB18*/ PAL_MODE_OUTPUT_PUSHPULL, /*PTB19*/ PAL_MODE_OUTPUT_OPENDRAIN,/*PTB20*/ PAL_MODE_UNCONNECTED,  // fpga creset, wlan reset
    ...
    },
    {
      .port = IOPORT3,  // PORTC
      .pads = {
        /* PTC0*/ PAL_MODE_INPUT,           /* PTC1*/ PAL_MODE_INPUT,           /* PTC2*/ PAL_MODE_ALTERNATIVE_2, //sim1, sim2 detect, fpga_ss
